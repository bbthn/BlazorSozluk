...
public class SearchTextQueryHandler : IRequestHandler<SearchEntryQuery, List<SearchEntryViewModel>>
{
    private readonly IEntryRepository entryRepository;

    public SearchTextQueryHandler(IEntryRepository entryRepository)
    {
